...
## SVG grootte inperken

Het kan zijn dat bij het verkleinen van het scherm de svg-afbeelding zich niet houdt aan de breedte die hij heeft gekregen via de layout parameter, maar dat hij getoond wordt met de breedte van de svg-afbeelding zelf. Een mogelijke oplossing hiervoor is om de flex-direction parameter aan te passen: 
...
Mocht de svg-afbeelding zich ook op normaal scherm zich niet aan de toegewezen kolombreedte houden, dan is dat mogelijk op te lossen met de volgende css code:
